...
class PaletteGenerator {
  ...
  private testNode(nCols: number, nRes: number, nPix: number, node: NodeLike): boolean {
  ...
  private generate(): void {
    if (this.generated) throw new Error('This palette has already been generated');
    this.generated = true;
